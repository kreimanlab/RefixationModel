...
for T = 1:length(TYPELIST)
    ...
    if strcmp(subtype, 'array')
        ...
        SimilarityName = './RefixationModel/gbvs/gbvs/demo/stimuli_gbvs_array';
    ...
    elseif strcmp(subtype, 'naturaldesign')
        ...
        SimilarityName = './RefixationModel/gbvs/gbvs/demo/stimuli_gbvs_naturaldesign';
    ...
    elseif strcmp(subtype, 'waldo')
        ...
        SimilarityName = './RefixationModel/gbvs/gbvs/demo/stimuli_gbvs_croppedWaldo';
    ...
    if 1
        ...
        SIMRETURN_subjs = ones(size(SIMRETURN));  SIMNONRETURN_subjs = ones(size(SIMNONRETURN)); 
        
        save(['IOR_NC/Mat/saliency_' type  '.mat'],'SIMRETURN','SIMNONRETURN');
    ...
    if isempty(SIMRETURN); SIMRETURN = 0; end
    if isempty(SIMNONRETURN); SIMNONRETURN = 0; end
    if isempty(SIMRETURN_subjs); SIMRETURN_subjs = 0; end
    if isempty(SIMNONRETURN_subjs); SIMNONRETURN_subjs = 0; end
