...
type = 'naturaldesign'; %waldo, naturaldesign, array, naturalsaliency
...
for SubjID = [1] %1:length(subjlist)
    for imgID = [105 134 139 145] %1:NumStimuli/2
...
print(hb,['/home/mengmi/Desktop/EPSfigs/visEgs/' type '/' type '_' num2str(length(posx))  '_imgid_' num2str(imgID) printpostfix],printmode,printoption);
