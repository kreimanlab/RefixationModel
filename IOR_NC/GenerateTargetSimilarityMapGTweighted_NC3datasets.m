...
%     
%     gtt = imread(['/media/mengmi/KLAB15/Mengmi/Proj_memory/compiled/CGround_naturaldesign/gray' sprintf('%03d',i) '.jpg']);
%     gtt = mat2gray(double(imresize(gtt,size(wholeimg))));
%     
%     wholeimg = mat2gray(wholeimg + GTModulatedW*gtt);
% %     imshow(wholeimg);
% %     pause;
%     imwrite(wholeimg, ['/media/mengmi/KLAB15/Mengmi/Proj_memory/compiled/CSimilarityWeighted_naturaldesign/gray' sprintf('%03d',i) '.jpg']);
...
%     end
%     
%     gtt = imread(['/media/mengmi/KLAB15/Mengmi/Proj_memory/compiled/CGround_waldo/img_id_' sprintf('%03d',i) '.jpg']);
%     gtt = mat2gray(double(imresize(gtt,size(wholeimg))));
%     
%     wholeimg = mat2gray(wholeimg + GTModulatedW*gtt);
% %     imshow(wholeimg);
% %     pause;
%     imwrite(wholeimg, ['/media/mengmi/KLAB15/Mengmi/Proj_memory/compiled/CSimilarityWeighted_waldo/img_id_' sprintf('%03d',i) '.jpg']);
%     
% end
...
for i = 1: NumImg
    ...
    gtt = imread(['/media/mengmi/KLAB15/Mengmi/Proj_memory/compiled/CGround_array/array_' num2str(i) '.jpg']);
    gtt = mat2gray(double(imresize(gtt,size(salimg))));    
    salimg = mat2gray(salimg + GTModulatedW*gtt);
    
%     imshow(salimg);
%     pause;
    
    imwrite(salimg, ['/media/mengmi/KLAB15/Mengmi/Proj_memory/compiled/CSimilarityWeighted_array/array_' num2str(i) '.jpg']);
end
