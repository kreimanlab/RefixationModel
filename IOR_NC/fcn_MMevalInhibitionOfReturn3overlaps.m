function [ propnt, offsetnt, propt, offsett, countpropntD, countpropntN, countproptD, countproptN ] = fcn_MMevalInhibitionOfReturn3overlaps( Firstx, Firsty, Centerx, Centery, thres, IORthresT, subjid, imgvalid, Time, type)
