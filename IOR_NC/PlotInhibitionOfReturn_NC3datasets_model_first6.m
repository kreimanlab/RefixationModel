...
%     imgvalid = find(sum(scoremat,2)>0);
    ...
    [propnt1, offsetnt1, propt1, offsett1, countpropntD, countpropntN, countproptD, countproptN ] = fcn_MMevalInhibitionOfReturn_exp23only(Firstx, Firsty, centerRx, centerRy, IORthres, IORthresT, subjlist{s}, imgvalid, 1, [type '_comb'], LongThres, ShortThres);
    save(['Mat/IOR_' type '_' subjlist{s} '_first6.mat'],...
...
for s = 1:length(subjlist)
    load(['Mat/IOR_' type '_' subjlist{s} '_first6.mat']);
...
load(['Mat/' subtype '_chanceoffsetnt_first6.mat']);
[propt, propnt] = fcn_MMshuffleIOR(countpropntD, countpropntN, countproptD, countproptN);
...
print(hb,['Figures/IOR_first_overall_comb_' type '_Deg_' num2str(Deg*100) '_first6' printpostfix],printmode,printoption);
