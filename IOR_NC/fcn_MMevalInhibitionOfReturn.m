function [ propnt, offsetnt, propt, offsett, countpropntD, countpropntN, countproptD, countproptN ] = fcn_MMevalInhibitionOfReturn( Firstx, Firsty, Centerx, Centery, thres, IORthresT, subjid, imgvalid, Time, type)
